...
def train_instruments(currepoch, epoch):
    ...
    for batch_idx in range(len(dataloader)):
        ...
        torch.save(rowcnn.state_dict(), './weights/network_train.ckpt')
    ...
    torch.save(rowcnn.state_dict(), './checkpoints/network_train_epoch_{}.ckpt'.format(currepoch + 1))
